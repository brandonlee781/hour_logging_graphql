/**
 * Annotation '@exception' to give the exception a name and key
 */
...
// UserError will be sent to the user
export class Exception extends Error {
  ...
  static hasName(error: any): boolean { // tslint:disable-line:no-any
    let message = error;
    if (error.message) {
